...
Aplicativo estático de flashcards com revisão espaçada, feito para uso no iPad.
...
O progresso fica salvo no navegador do iPad. Use **Importar → Exportar backup completo** regularmente.
