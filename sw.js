...
const CONTENT_VERSION="2026.08.03.4";
...
const ASSETS=[
  ...
  "./data/exams/exam-smoking-depression.json","./data/exams/simulado-01-sleep-apnea.json","./data/exams/simulado-02-pitavastatin-hiv.json","./data/exams/simulado-03-post-infectious-mecfs.json","./data/exams/simulado-04-cannabis-cardiovascular.json","./data/exams/simulado-05-antibiotic-resistance.json","./data/exams/simulado-06-semaglutide-masld-hiv.json","./data/exams/simulado-07-bioengineered-blood-vessels.json",
